...
<style>
	...
	i{color: lightblue;}
	.homeback{text-align: center;}
	.homeback a{color: white;}
	.delete{text-align: center;}
	.delete a{color: white;}
...
<body>
	...
	<div class="join_input">
		...
		<h1><i class="fab fa-pagelines"></i> 개인정보 변경</h1>
		<form action="${cp}/member/memModify" method="post">
			...
			<div class="formfield">
				<input type="password" id="memPw" name="memPw" maxlength="20"
					value="${member.getMemPw()}" autocomplete="off">
			</div>
			<div class="fieldlabel">
			...
			<div class="formfield">
				...
				<datalist id="phone">
					...
					value="${member.getMemPhone2()}"> <input id="memPhone3" name="memPhone3"
					type="number"size="4" maxlength="4" autocomplete="off"
					value="${member.getMemPhone3()}">
			</div>
			<br>
			...
			<div class="formfield">
				<input type="text" id="memAddNum" name="memAddNum" value="${member.getMemAddNum()}"> <input
					type="button" id="postcode2" onclick="execDaumPostcode()"
					value="우편번호 찾기"><br /> <label id="addNext">/</label> <input
					type="text" id="memAddress" name="memAddress" value="${member.getMemAddress()}"> <input type="text"
					id="memAddress2" value="${member.getMemAddress2()}" name="memAddress2"><br /> <label
					id="addNext">/</label> <input type="text" id="memAddPlus" name="memAddPlus"
					value="${member.getMemAddPlus()}">
			</div>
			<div id="layer"
			...
			<div class="btnfield">
				<input id="joinclick" type="submit" value="수정" >
				<input id="joinclick" type="reset" value="취소" >
			</div>
			<div class="homeback">
				<button style="background-color: black;"><a href="${cp}">HOME</a></button>
			</div><br/><br/><br/><br/><br/>
			<div class="delete">
				<button style="background-color: black;"><a href="${cp}/member/memDeleteForm">탈퇴</a></button>
			</div>
		</form>

			<label id="addNext">/</label>
